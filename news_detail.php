...
<div class="container" style="max-width:860px">
  ...
  <article style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:40px;margin-top:16px">
    ...
    <?php if ($news['image']): ?>
    <img src="/uploads/<?= htmlspecialchars($news['image']) ?>" alt="" style="width:100%;max-height:400px;object-fit:cover;border-radius:var(--radius-sm);margin-bottom:24px">
    <?php endif; ?>
  ...
  <div style="margin-top:20px">
    <a href="/news.php" style="color:var(--accent2);font-weight:600">← Все новости</a>
  </div>
</div>
