...
?>
<div class="container">
  <div class="breadcrumbs"><a href="/index.php">Главная</a> / <span>Избранное</span></div>
  ...
  <div class="empty-state">
    ...
    <a href="/catalog.php" class="btn-primary" style="display:inline-block;margin-top:20px;max-width:200px">В каталог</a>
  </div>
  <?php else: ?>
