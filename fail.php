...
$orderId = (int)($_GET['order_id'] ?? $_GET['MERCHANT_ORDER_ID'] ?? 0);
...
<?php if ($orderId): ?>
<a href="/checkout.php?retry=<?= $orderId ?>" class="btn-primary">
🔄 Попробовать снова
</a>
<?php endif; ?>
<?php if (isLoggedIn()): ?>
<a href="/profile.php#orders" class="btn-secondary">
📦 Мои заказы
</a>
<?php endif; ?>
<a href="/cart.php" class="btn-secondary" style="color:var(--text3)">
🛒 Вернуться в корзину
</a>
</div>
<!-- Поддержка -->
