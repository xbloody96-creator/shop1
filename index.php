 ...
 * 
 * Отображает:
 * - Слайдер с популярными товарами (Hero)
 * - Категории товаров
...
// Популярное (для слайдера и блока хитов)
...
// Категории верхнего уровня (для быстрого доступа)
...
// Иконки для категорий (подбираются по порядку)
$catIcons = ['📱','💻','📺','🎧','⌨️','🖥️','📷',''];
...
<!-- ============================================
     HERO SLIDER
     Слайдер с популярными товарами на главной
============================================= -->
<?php if (!empty($sliderProducts)): ?>
<div class="hero-slider">
    <div class="slider-track">
        <?php foreach ($sliderProducts as $i => $item):
            // Выбираем фон для слайда (3 варианта)
    ...
    <div class="slider-controls">
        ...
        <button class="slider-dot <?= $i===0?'active':'' ?>" data-index="<?= $i ?>" aria-label="Перейти к слайду <?= $i+1 ?>"></button>
        <?php endforeach; ?>
    </div>
</div>
<?php endif; ?>
...
<div class="container">
    ...
    <!-- ============================================
         ХИТЫ ПРОДАЖ
         Популярные товары по выбору администрации
    ============================================= -->
    ...
    <!-- ============================================
         О МАГАЗИНЕ
         Информация о компании и статистика
    ============================================= -->
