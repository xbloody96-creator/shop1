...
?>
<div class="container">
  <div class="breadcrumbs"><a href="/index.php">Главная</a> / <span>Новости</span></div>
  ...
  <div class="news-grid">
    ...
    <div class="news-card">
      ...
      <div class="news-card-body">
        ...
        <a href="/news_detail.php?id=<?= $n['id'] ?>" style="display:inline-block;margin-top:10px;color:var(--accent);font-weight:700;font-size:0.88rem">Читать →</a>
      </div>
    </div>
    <?php endforeach; ?>
  </div>
